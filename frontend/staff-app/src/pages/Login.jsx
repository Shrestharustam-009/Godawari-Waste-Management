          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-4 py-3.5 pr-12 text-base outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm"
                placeholder="••••••••"
              />
              <button
                type="button"
